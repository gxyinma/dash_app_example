...
#Scatter is a layer of a graph here, based on one index. For example, there are 5 continents, 5 scatter are showing 5 continent
#downthere "for"is at the end of （） but functions as in the front.
app.layout = html.Div([
    dcc.Graph(
        id='life-exp-vs-gdp',
        figure={
            ...
            'layout': go.Layout(
                ...
                margin={'l': 40, 'b': 40, 't': 10, 'r': 10},#上下左右
                legend={'x': 0, 'y': 1},
                hovermode='closest'
            )
        }
